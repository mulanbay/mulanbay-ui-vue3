<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" :inline="true">
      ...
      <el-form-item>
        <el-button type="primary" icon="TrendCharts" @click="handleQuery" v-hasPermi="['health:body:bodyAbnormal:dateStat']">统计</el-button>
...
<script setup name="BodyAbnormalDateStat">
  import { getBodyAbnormalDateStat,getAbnormalCateTree } from "@/api/health/body/bodyAbnormal";
  ...
  function initChart() {
    ...
    getBodyAbnormalDateStat(proxy.addDateRange(queryParams.value, dateRange.value)).then(
      response => {
