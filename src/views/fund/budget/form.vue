      ...
      <el-row>
        <el-col :span="12">
          <el-form-item label="预期时间" prop="expectPaidTime">
            ...
            <el-tooltip content="<1>对于单次类型，必须设置预期实现时间，则预算金额会加入到该日期所在月的月预算中。<br><2>对于每年类型，如果设置预期实现时间，则预算金额会加入到该日期所在月的每年的该月预算中." effect="dark" placement="top">
              <el-icon><QuestionFilled /></el-icon>
            </el-tooltip>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="预算状态" prop="period">
            ...
            <el-tooltip content="<1>如果该预算已经被执行过，那么请直接设置预算金额为0，否则设置为无效后在年度详情中会无法查询。<br><2>或者在第二年时再设置为无效。" effect="dark" placement="top">
              <el-icon><QuestionFilled /></el-icon>
            </el-tooltip>
          </el-form-item>
        </el-col>
