<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" :inline="true">
      ...
      <el-form-item>
        <el-button type="primary" icon="TrendCharts" @click="handleQuery" v-hasPermi="['sport:exercise:dateStat']">统计</el-button>
...
<script setup name="exerciseDateStat">
  ...
  function initChart() {
    ...
    getExerciseDateStat(proxy.addDateRange(queryParams.value, dateRange.value)).then(
      response => {
