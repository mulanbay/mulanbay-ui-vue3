<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" :inline="true">
      ...
      <el-form-item>
        <el-button type="primary" icon="TrendCharts" @click="handleQuery" v-hasPermi="['life:experience:dateStat']">统计</el-button>
...
<script setup name="ExperienceDateStat">
  import { getExperienceDateStat } from "@/api/life/experience";
  ...
  function initChart() {
    ...
    getExperienceDateStat(acQueryParams).then(
      response => {
