<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" :inline="true">
      ...
      <el-form-item>
        <el-button type="primary" icon="TrendCharts" @click="handleQuery" v-hasPermi="['commonData:commonData:dateStat']">统计</el-button>
...
<script setup name="CommonDataDateStat">
  import { getCommonDataDateStat } from "@/api/commonData/commonData";
  ...
  function initChart() {
    ...
    getCommonDataDateStat(proxy.addDateRange(queryParams.value, dateRange.value)).then(
      response => {
