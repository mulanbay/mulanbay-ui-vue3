<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" :inline="true">
      ...
      <el-form-item>
        <el-button type="primary" icon="search" @click="handleQuery" v-hasPermi="['data:calendarTemplate:list']">搜索</el-button>
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          icon="plus"
          @click="handleCreate"
          v-hasPermi="['data:calendarTemplate:create']">新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          type="success"
          ...
          :disabled="single"
          @click="handleEdit"
          v-hasPermi="['data:calendarTemplate:edit']">修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          type="danger"
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['data:calendarTemplate:delete']">删除</el-button>
      </el-col>
    </el-row>
    <!--列表数据-->
    <el-table v-loading="loading" :data="calendarTemplateList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="操作" align="center" width="140" fixed="right" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button
            ...
            v-hasPermi="['data:calendarTemplate:edit']">修改
          </el-button>
          <el-button
            link
            type="danger"
            ...
            v-hasPermi="['data:calendarTemplate:delete']">删除
          </el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <!-- 表单 -->
    <CalendarTemplateForm ref="formRef" @success="getList" />
...
<script setup name="CalendarTemplate">
  import { fetchList, deleteCalendarTemplate } from "@/api/data/calendarTemplate";
  import CalendarTemplateForm from './form.vue'
  ...
  const total = ref(0);
  // 查询列表数据
  const calendarTemplateList = ref([]);
  ...
  function handleBindList(row){
    statBindConfigListRef.value.showData(row.templateId,'CALENDAR')
  }
  
  /** 查询列表 */
  function getList() {
    loading.value = true;
    calendarTemplateList.value = [];
    fetchList(queryParams.value).then(
      response => {
        calendarTemplateList.value = response.rows;
  ...
  function handleDelete(row) {
    ...
    proxy.$confirm('是否确认删除编号为"' + deleteIds + '"的数据项?', "警告", {
      ...
      return deleteCalendarTemplate(deleteIds);
    }).then(() => {
