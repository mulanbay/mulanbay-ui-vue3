...
<script setup name="UserRewardDateStat">
  import { getUserRewardDateStat } from "@/api/data/userReward";
  ...
  function initChart() {
    ...
    getUserRewardDateStat(proxy.addDateRange(queryParams.value, dateRange.value)).then(
      response => {
