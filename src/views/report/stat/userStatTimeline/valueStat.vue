<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" :inline="true">
      ...
      <el-form-item>
        <el-button type="primary" icon="TrendCharts" @click="handleQuery" v-hasPermi="['report:stat:userStatTimeline:valueStat']">统计</el-button>
...
<script setup name="UserStatTimelinValueStat">
  import { getUserStatTimelineValueStat } from "@/api/report/stat/userStatTimeline";
  ...
  function initChart() {
    ...
    getUserStatTimelineValueStat(proxy.addDateRange(queryParams.value, dateRange.value)).then(
      response => {
