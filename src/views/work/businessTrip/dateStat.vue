<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" :inline="true">
      ...
      <el-form-item>
        <el-button type="primary" icon="TrendCharts" @click="handleQuery" v-hasPermi="['work:businessTrip:dateStat']">统计</el-button>
...
<script setup name="BusinessTripDateStat">
  import { getBusinessTripDateStat } from "@/api/work/businessTrip";
  ...
  function initChart() {
    ...
    getBusinessTripDateStat(proxy.addDateRange(queryParams.value, dateRange.value)).then(
      response => {
