<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" :inline="true">
      ...
      <el-form-item>
        <el-button type="primary" icon="TrendCharts" @click="handleQuery" v-hasPermi="['read:readDetail:dateStat']">统计</el-button>
...
<script setup name="ReadDetailDateStat">
  import { getReadDetailDateStat } from "@/api/read/readDetail";
  ...
  function initChart() {
    ...
    getReadDetailDateStat(proxy.addDateRange(queryParams.value, dateRange.value)).then(
      response => {
