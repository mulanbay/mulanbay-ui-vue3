<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" :inline="true">
      ...
      <el-form-item>
        <el-button type="primary" icon="TrendCharts" @click="handleQuery" v-hasPermi="['read:book:dateStat']">统计</el-button>
...
<script setup name="BookDateStat">
  import { getBookDateStat } from "@/api/read/book";
  ...
  function loadOptions() {
    proxy.getDictItemTree('BOOK_CHART_DATE_GROUP', false).then(response => {
  ...
  function initChart() {
    ...
    getBookDateStat(proxy.addDateRange(queryParams.value, dateRange.value)).then(
      response => {
